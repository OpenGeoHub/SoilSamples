...
ls <- c("rgdal", "raster", "tidyverse", "openair", "rgeos", "sf", 
        "cowplot", "rworldmap", "ggplot2", "terra", "captioner", 
        "olctools", "vroom", "xlsx", "googledrive", "fastSave")
...
#load.pigz("themes/sol/SoilHydroDB/soilhydro.RData")
...
if(!exists("hydrosprops.NCSS")){
  ...
  saveRDS.gz(hydrosprops.NCSS, "/mnt/DATA/Soil_points/INT/USDA_NCSS/hydrosprops.NCSS.rds")
}
...
if(!exists("hydrosprops.AfSPDB")){
  ...
  saveRDS.gz(hydrosprops.AfSPDB, "/mnt/DATA/Soil_points/AF/AfSIS_SPDB/hydrosprops.AfSPDB.rds")
}
...
if(!exists("hydrosprops.ISIS")){
  isis.xy <- read.csv("/mnt/DATA/Soil_points/INT/ISRIC_ISIS/Sites.csv", stringsAsFactors = FALSE)
  #str(isis.xy)
  isis.des <- read.csv("/mnt/DATA/Soil_points/INT/ISRIC_ISIS/SitedescriptionResults.csv", stringsAsFactors = FALSE)
  ...
  isis.smp <- read.csv("/mnt/DATA/Soil_points/INT/ISRIC_ISIS/AnalyticalSamples.csv", stringsAsFactors = FALSE)
  isis.ana <- read.csv("/mnt/DATA/Soil_points/INT/ISRIC_ISIS/AnalyticalResults.csv", stringsAsFactors = FALSE)
  #str(isis.ana)
  isis.class <- read.csv("/mnt/DATA/Soil_points/INT/ISRIC_ISIS/ClassificationResults.csv", stringsAsFactors = FALSE)
  ...
  saveRDS.gz(hydrosprops.ISIS, "/mnt/DATA/Soil_points/INT/ISRIC_ISIS/hydrosprops.ISIS.rds")
}
...
if(!exists("hydrosprops.WISE")){
  wise.SITE <- read.csv("/mnt/DATA/Soil_points/INT/ISRIC_WISE/WISE3_SITE.csv", stringsAsFactors=FALSE)
  ...
  wise.HORIZON <- read.csv("/mnt/DATA/Soil_points/INT/ISRIC_WISE/WISE3_HORIZON.csv")
  ...
  saveRDS.gz(hydrosprops.WISE, "/mnt/DATA/Soil_points/INT/ISRIC_WISE/hydrosprops.WISE.rds")
}
...
if(!exists("hydrosprops.FRED")){
  fred = read.csv("/mnt/DATA/Soil_points/INT/FRED/FRED2_20180518.csv", skip = 5, header=FALSE)
  names(fred) = names(read.csv("/mnt/DATA/Soil_points/INT/FRED/FRED2_20180518.csv", nrows=1, header=TRUE))
  ...
  saveRDS.gz(hydrosprops.FRED, "/mnt/DATA/Soil_points/INT/FRED/hydrosprops.FRED.rds")
}
...
if(!exists("hydrosprops.EGRPR")){
  ...
  saveRDS.gz(hydrosprops.EGRPR, "/mnt/DATA/Soil_points/Russia/EGRPR/hydrosprops.EGRPR.rds")
}
...
if(!exists("hydrosprops.SPADE2")){
  spade.PLOT <- read.csv("/mnt/DATA/Soil_points/EU/SPADE/DAT_PLOT.csv")
  #str(spade.PLOT)
  spade.HOR <- read.csv("/mnt/DATA/Soil_points/EU/SPADE/DAT_HOR.csv")
  ...
  saveRDS.gz(hydrosprops.SPADE2, "/mnt/DATA/Soil_points/EU/SPADE/hydrosprops.SPADE2.rds")
}
...
if(!exists("hydrosprops.NPDB")){
  ...
  saveRDS.gz(hydrosprops.NPDB, "/mnt/DATA/Soil_points/Canada/NPDB/hydrosprops.NPDB.rds")
}
...
if(!exists("hydrosprops.ETH")){
  ...
  saveRDS.gz(hydrosprops.ETH, "/mnt/DATA/Soil_points/INT/hydrosprops.ETH.rds")
}
dim(hydrosprops.ETH)
```
...
if(!exists("hydrosprops.HYBRAS")){
  ...
  saveRDS.gz(hydrosprops.HYBRAS, "/mnt/DATA/Soil_points/INT/HYBRAS/hydrosprops.HYBRAS.rds")
}
...
if(!exists("hydrosprops.UNSODA")){
  unsoda.LOC = read.csv("/mnt/DATA/Soil_points/INT/UNSODA/general_c.csv")
  #unsoda.LOC = unsoda.LOC[!unsoda.LOC$Lat==0,]
  #plot(unsoda.LOC[,c("Long","Lat")])
  unsoda.SOIL = read.csv("/mnt/DATA/Soil_points/INT/UNSODA/soil_properties.csv")
  #summary(unsoda.SOIL$k_sat)
  ## Soil water retention in lab:
  tmp.hyd = read.csv("/mnt/DATA/Soil_points/INT/UNSODA/lab_drying_h-t.csv")
  #str(tmp.hyd)
  ...
  #head(tmp.hyd.tbl)
  ## ksat
  kst.lev = read.csv("/mnt/DATA/Soil_points/INT/UNSODA/comment_lab_sat_cond.csv", na.strings=c("","NA","No comment"))
  kst.met = read.csv("/mnt/DATA/Soil_points/INT/UNSODA/methodology.csv", na.strings=c("","NA","No comment"))
  ...
  kst.fld = read.csv("/mnt/DATA/Soil_points/INT/UNSODA/comment_field_sat_cond.csv", na.strings=c("","NA","No comment"))
  ...
  saveRDS.gz(hydrosprops.UNSODA, "/mnt/DATA/Soil_points/INT/UNSODA/hydrosprops.UNSODA.rds")
}
...
if(!exists("hydrosprops.HYDROS")){
  hydros.tbl = read.csv("/mnt/DATA/Soil_points/INT/HydroS/int_rawret.csv", sep="\t", stringsAsFactors = FALSE, dec = ",")
  ...
  #head(hydros.tbl.df)
  ## properties:
  hydros.soil = read.csv("/mnt/DATA/Soil_points/INT/HydroS/int_basicdata.csv", sep="\t", stringsAsFactors = FALSE, dec = ",")
  #head(hydros.soil)
  ...
  saveRDS.gz(hydrosprops.HYDROS, "/mnt/DATA/Soil_points/INT/HYDROS/hydrosprops.HYDROS.rds")
}
...
if(!exists("hydrosprops.SWIG")){
  meta.tbl = read.csv("/mnt/DATA/Soil_points/INT/SWIG/Metadata.csv", skip = 1, fill = TRUE, blank.lines.skip=TRUE, flush=TRUE, stringsAsFactors=FALSE)
  swig.xy = read.table("/mnt/DATA/Soil_points/INT/SWIG/Locations.csv", sep=";", dec = ",", stringsAsFactors=FALSE, header=TRUE, na.strings = c("-",""," "), fill = TRUE)
  ...
  swig2.tbl = read.csv("/mnt/DATA/Soil_points/INT/SWIG/Statistics.csv", fill = TRUE, blank.lines.skip=TRUE, sep=";", dec = ",", flush=TRUE, stringsAsFactors=FALSE)
  ...
  saveRDS.gz(hydrosprops.SWIG, "/mnt/DATA/Soil_points/INT/SWIG/hydrosprops.SWIG.rds")
}
...
if(!exists("hydrosprops.SIM")){
  ...
  sprops.SIM = readRDS("/mnt/DATA/LandGIS/training_points/soil_props/sprops.SIM.rds")
  ...
  tax.r = raster::extract(raster("/mnt/DATA/LandGIS/archive/predicted250m/sol_grtgroup_usda.soiltax_c_250m_s0..0cm_1950..2017_v0.1.tif"), sprops.SIM[,c("longitude_decimal_degrees","latitude_decimal_degrees")])
  tax.leg = read.csv("/mnt/DATA/LandGIS/archive/predicted250m/sol_grtgroup_usda.soiltax_c_250m_s0..0cm_1950..2017_v0.1.tif.csv")
  ...
  saveRDS.gz(hydrosprops.SIM, "/mnt/DATA/Soil_points/INT/hydrosprops.SIM.rds")
}
dim(hydrosprops.SIM)
```

## ![alt text](../../../tex/R_logo.svg.png "Bind points") Bind all tables
...
if(!exists("ov.sprops")){
  ...
  mask = terra::rast("/mnt/DATA/LandGIS/layers250m/lcv_landmask_esacci.lc.l4_c_250m_s0..0cm_2000..2015_v1.0.tif")
...
```{r sol_hydro.pnts_sites, echo=FALSE, fig.cap="Soil profiles and soil samples with physical and hydraulic soil properties properties global compilation.", out.width="100%"}
knitr::include_graphics("../../../img/sol_hydro.pnts_sites.png")
```
`r fig_nums("sol_hydro.pnts_sites", "Soil profiles and soil samples with physical and hydraulic soil properties properties global compilation.")`
...
```{r sol_ksat.pnts_sites, echo=FALSE, fig.cap="Soil profiles and soil samples with Ksat measurements global compilation", out.width="100%"}
knitr::include_graphics("../../../img/sol_ksat.pnts_sites.png")
```
`r fig_nums("sol_ksat.pnts_sites", "Soil profiles and soil samples with Ksat measurements global compilation.")`
...
if(!exists("rm.sol")){
  ...
  str(pr.vars)
  ## 349
  #saveRDS.gz(ov.sol, "/mnt/DATA/Soil_points/ov.sol_hydro.pnts_horizons.rds")
  #ov.sol <- readRDS.gz("/mnt/DATA/Soil_points/ov.sol_hydro.pnts_horizons.rds")
...
saveRDS.gz(tot_sprops.pnts, "/mnt/DATA/Soil_points/sol_hydro.pnts_sites.rds")
## reorder columns
...
```{r, eval=FALSE}
#rm(rm.sol); gc()
save.image.pigz(file="themes/sol/SoilHydroDB/soilhydro.RData")
## rmarkdown::render("themes/sol/SoilHydroDB/README.rmd")
```
