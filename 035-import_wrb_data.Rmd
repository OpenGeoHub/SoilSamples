...
```{r sol_wrb.pnts_profiles, echo=FALSE, fig.cap="Soil profiles with WRB soil type classification global compilation.", out.width="100%"}
knitr::include_graphics("./img/sol_wrb.pnts_profiles.png")
```
`r fig_nums("sol_wrb.pnts_profiles", "Soil profiles with WRB soil type classification global compilation.")`
...
```{r sol_wrb.pnts_tot.profiles, echo=FALSE, fig.cap="Soil profiles with WRB soil type classification global compilation: subset to actual observations.", out.width="100%"}
knitr::include_graphics("./img/sol_wrb.pnts_tot.profiles.png")
```
`r fig_nums("sol_wrb.pnts_tot.profiles", "Soil profiles with WRB soil type classification global compilation: subset to actual observations.")`
